## TWRP device tree for Oppo R7 Plus (r7plusf)

Add to `.repo/local_manifests/r7plusf.xml`:
...
<manifest>
 ...
 <remote  name="CyanogenMod"
    ...
    <project path="device/oppo/r7plusf" name="android_device_oppo_r7plusf" remote="Celoxocis" revision="cm-13.0" />
